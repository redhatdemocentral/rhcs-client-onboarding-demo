...
Running demo
------------
There is a [demo script detailing how to run this demo](docs/client_onboarding_demo_script.pdf), it includes some 
of the log in details, for logging in to the client onboarding to start exploring a process driven appplication 
